	...
	downloadFile: (uri, details) => {
		...
		requestURI.pipe(request({
			...
			headers: {
				...
				"x-archive-meta-creator": "Anmol Wassan",
			...
			(error, response, body) => {
				if (error || response.statusCode != 200) {
					console.error(error);
					console.error(body);
					return { error: true, message: "Download from Google Books failed! Status code: " + response.statusCode }
				}
				else {
...
<html>
	<head>
		...
		<title>${details.volumeInfo.title}</title>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <h3>Your file "${details.volumeInfo.title}" has been uploaded to Internet Archive successfully!</h3>

<p>The file will now be converted by Internet Archive in various formats. Click on the button to view the uploaded file.<br>
<br>
Keep uploading!<br>
<br>
BUB v2.0</p>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #00ADD8;" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;" valign="middle" align="center">
                                <a class="mcnButton " title="View file" href="https://archive.org/details/bub_gb_${details.id}" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View file</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
					...
					const mailOptions = {
						...
						to: 'coderwassananmol1@gmail.com', // list of receivers
