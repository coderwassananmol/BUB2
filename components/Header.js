                    ...
                    <div className="container-fluid">
                        ...
                        <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            ...
                            <ul className="nav navbar-nav navbar-right">
                                <li>
                                    <a href="https://github.com/coderwassananmol/BUB2/"><button type="button" className="btn btn-primary"><Octicon icon={Star} /><b> Star </b><span className="badge badge-light">{this.state.gitstats.stargazers_count}</span></button></a>
                                </li>
                                <li>
